...
{
       0,    67,    67,    67,    68,    70,    71,    71,    72,    73,
      73,    74,    75,    75,    76,    77,    79,    80,    82,    83,
      84,    85,    87,    88,    89,    90,    92,    93,    95,    96,
      97,    98,    99,   100,   102,   103,   104,   105,   106,   107,
     109,   110,   111,   112,   113,   114,   127,   128,   130,   131,
     132,   134,   135,   137,   138,   140,   140,   199,   200,   202,
     203,   204,   205,   207,   209,   210,   212,   216,   221,   230,
     236,   237,   239,   241
};
#endif
...
#line 114 "m.y"
    {
                                        ...
                                        type=getTypeSynt((yyvsp[(1) - (2)].sval));
                                        optionIDF = 0;
                                      ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 127 "m.y"
    {val.ival=(yyvsp[(1) - (1)].ival);type=0;optionIDF = 1;sprintf(tmp,"%d",(yyvsp[(1) - (1)].ival));(yyval.sval)=strdup(tmp);ajoutType(1);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 128 "m.y"
    {val.fval=(yyvsp[(1) - (1)].fval);type=1;optionIDF = 1;sprintf(tmp,"%f",(yyvsp[(1) - (1)].fval));(yyval.sval)=strdup(tmp);ajoutType(2);;}
    break;
